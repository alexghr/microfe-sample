...
const AddItemToProjectModal: React.FC = () => {
  const [itemToAdd, setItemToAdd] = React.useState<PinnedItem | undefined>(
    undefined
  );
  const [{ ItemComponent }, setItemComponent] = React.useState<{
    ItemComponent: React.ComponentType<{ id: string }> | undefined;
  }>({
